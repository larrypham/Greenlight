...
func (app *application) errorResponse(w http.ResponseWriter, r *http.Request, status int, message interface{}) {
	...
	// Write the response using the writeJSON() helper. If this happens to return an error the log it.
...
// The serverErrorResponse() method will be used when our application encouters an unexpected problem at runtime.
